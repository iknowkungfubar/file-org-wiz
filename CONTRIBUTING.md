...
```bash
git clone https://github.com/iknowkungfubar/file-org-wiz.git
cd file-org-wiz
pip install -e ".[dev]"
```
...
Open a [Discussion](https://github.com/iknowkungfubar/file-org-wiz/discussions) or an [Issue](https://github.com/iknowkungfubar/file-org-wiz/issues) with a clear description of what you need help with.
