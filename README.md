...
This is a prompt and documentation package to completely reorganize any computer's files using the PARA (Projects, Areas, Resources, Archive) methodology combined with Zettelkasten principles for knowledge management.
...
| Any (HTTP) | `install_mcp_generic.md` | HTTP API |

## Files

| File | Purpose |
|------|---------|
| `AI_File_Organization_Agent_Prompt.md` | Execute this with any AI agent |
| `Why_PARA_Zettelkasten.md` | The case for why this methodology works |
| `mcp_server.py` | MCP server for HTTP integration |
